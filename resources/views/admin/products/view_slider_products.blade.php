              ...
              <tbody>
                ...
                <tr class="gradeX">
                  ...
                  <td class="center">
                     ...
                     <a href="{{url('/admin/edit_slider_product/'.$product->id)}}" class="btn btn-primary btn-mini" title="Edit Product">Edit</a> 
                    ...
                    <div id="myModal{{$product->id}}" class="modal hide">
                      <div class="modal-header">
                        ...
                        <h3>{{$product->description}} Full Details</h3>
                      </div>
                      <div class="modal-body">
                        <p>Product ID: {{$product->id}}</p>
                        <p>Category ID: {{$product->parent_id}}</p>
                        <p>Price: {{$product->caption}}</p>
